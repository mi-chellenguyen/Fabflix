...
public class LoginFilter implements Filter {
    ...
    private boolean isUrlAllowedWithoutLogin(String requestURI) {
        ...
        return requestURI.endsWith("login.html") || requestURI.endsWith("login.js")
        										 || requestURI.endsWith("employee-login.html")
        										 || requestURI.endsWith("api/employee-login")
        										 || requestURI.endsWith("_dashboard.html")
        										 || requestURI.endsWith("add-star.html")
        										 || requestURI.endsWith("add-movie.html")
        										 || requestURI.endsWith("db-metadata.html")
								                 || requestURI.endsWith("api/login")
								                 || requestURI.endsWith("css/adv-search.css")
								                 || requestURI.endsWith("css/login.css")
