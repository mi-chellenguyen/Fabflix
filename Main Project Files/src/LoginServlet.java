        ...
        try {
			...
			if(verifyLoginResults.next()) {
			 ...
			 if (email.equals(resultEmail) && success) {
		            ...
		            ((User)request.getSession().getAttribute("user")).setRole("customer");
		            ...
		            if (!email.equals(resultEmail)) {
		                responseJsonObject.addProperty("message", "Your email: " + email + " is not associated with a Fabflix account.");
		            } else {
